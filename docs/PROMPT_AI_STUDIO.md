Aggiorna TutorSDO usando il ramo fix/cataloghi-validazione di alexcont80/SDOsimulator. Preserva UI, 8 branche, 160 casi e Drive. Leggi prima docs/CATALOGHI_IMPORTATI.md e catalog-manifest.json: i due XLSX ministeriali sono già importati integralmente (29.984 righe), con hash e provenienza. Non tornare al campione legacy di 41 voci e non generare codici con l'AI.
